...
public class TestNGCucumberRunner {
    ...
    public TestNGCucumberRunner(Class clazz) {
		...
		list.add("--plugin");
		list.add("html:target/cucumber-reports");
		
		list.add("--plugin");
		list.add("json:target/cukjson/cucumber2.json");
		
		list.add("--glue");
		list.add("com.mycompany.feature.imp");
        ...
        runtimeOptions=new RuntimeOptions(list);
